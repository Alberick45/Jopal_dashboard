...
<head>
    ...
    <title>Jopal Admin  | <?php echo $user_name ?> </title>
...
<body>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin2" data-sidebartype="full"
        ...
        <!-- ============================================================== -->
            <div class="page-wrapper">
                ...
                <!-- ============================================================== -->
                    <?php
                    $customers_result = $conn -> query("call get_total_customers()");

                    if ($customers_result ){
                        if ($customersrow = $customers_result->fetch_assoc()) {
                            $countcustomer = $customersrow['number'];
                            $customers_result->close();
                            $conn->next_result();
                        }
                    }

                    $orders_result = $conn -> query("call get_total_orders()");
                    if ($orders_result ){
                        if ($ordersrow = $orders_result->fetch_assoc()) {
                            $countorders = $ordersrow['number'];
                            $orders_result->close();
                            $conn->next_result();
                         }
                    }
                    $staff_result = $conn -> query("call get_total_staff()");
                    
                    if ($staff_result ){
                        if ($staffrow = $staff_result->fetch_assoc()) {
                            $countstaff = $staffrow['number'];
                            $staff_result->close();
                            $conn->next_result();
                        }
                    }
                    $ingredient_result = $conn -> query("call get_total_ingredients()");
                    
                    if ($ingredient_result ){
                        if ($ingredientrow = $ingredient_result->fetch_assoc()) {
                            $countingredient = $ingredientrow['number'];
                            $ingredient_result->close();
                            $conn->next_result();
                        }
                    }
                    $service_result = $conn -> query("call get_total_services()");
                    
                    if ($service_result ){
                        if ($servicerow = $service_result->fetch_assoc()) {
                            $countservice= $servicerow['number'];
                            $service_result->close();
                            $conn->next_result();
                        }
                    }
                    $department_result = $conn -> query("call get_total_departments()");
                    
                    if ($department_result ){
                        if ($departmentrow = $department_result->fetch_assoc()) {
                            $countdepartment = $departmentrow['number'];
                            $department_result->close();
                            $conn->next_result();
                        }
                    }

                    $transaction_result = $conn -> query("call get_total_transactions()");
                    
                    if ($transaction_result ){
                        if ($transactionrow = $transaction_result->fetch_assoc()) {
                            $counttransaction = $transactionrow['number'];
                            $transaction_result->close();
                            $conn->next_result();
                        }
                    }
                    $request_result = $conn -> query("call get_total_requests()");
                    
                    if ($request_result ){
                        if ($requestrow = $request_result->fetch_assoc()) {
                            $countrequest= $requestrow['number'];
                            $request_result->close();
                            $conn->next_result();
                        }
                    }
                    $review_result = $conn -> query("call get_total_reviews()");
                    
                    if ($review_result ){
                        if ($reviewrow = $review_result->fetch_assoc()) {
                            $countreview = $reviewrow['number'];
                            $review_result->close();
                            $conn->next_result();
                        }
                    }
                    $daily_sales_result = $conn -> query("call get_daily_sales()");
                    
                    if ($daily_sales_result ){
                        if ($daily_sales_row = $daily_sales_result->fetch_assoc()) {
                            $countsales= $daily_sales_row['number'];
                            $daily_sales_result->close();
                            $conn->next_result();
                        }
                    }
                    $popular_service_result = $conn -> query("call get_popular_service()");
                    
                    if ($popular_service_result ){
                        if ($popular_service_row = $popular_service_result->fetch_assoc()) {
                            $countpopularservice = $popular_service_row['popular_service'];
                            $popular_service_result->close();
                            $conn->next_result();
                        }
                    }
                    ...
                    <?php 
                        require("plugins/actions/config.php");
                            if (
                                in_array($accesslevel, [3])||
                                in_array($position, ["AC2-AM","AC2-FM"])
                            )  { ?>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-4 col-md-12">
                            <div class="white-box analytics-info">
                                ...
                                <ul class="list-inline two-part d-flex align-items-center mb-0">
                                    ...
                                    <li class="ms-auto"><span class="counter text-success"><?php  if(isset($countcustomer)){echo $countcustomer;}else{echo 0;}  ?></span></li>
                                </ul>
                            </div>
                        </div>
                        <?php 
                        ...
                        <div class="col-lg-4 col-md-12">
                            <div class="white-box analytics-info">
                                ...
                                <ul class="list-inline two-part d-flex align-items-center mb-0">
                                    ...
                                    <li class="ms-auto"><span class="counter text-purple"><?php if(isset($countorders)){echo $countorders;}else{echo 0;}   ?></span></li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-12">
                            <div class="white-box analytics-info">
                                ...
                                <ul class="list-inline two-part d-flex align-items-center mb-0">
                                    ...
                                    <li class="ms-auto"><span class="counter text-info"><?php if(isset($countstaff)){echo $countstaff;}else{echo 0;}  ?></span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        require("plugins/actions/config.php");
                            if (
                                in_array($accesslevel, [2]) ||
                                in_array($position, ["AC3-AM","AC3-GM"])
                            )  { ?>
                        ...
                        <div class="col-lg-4 col-md-12">
                            <div class="white-box analytics-info">
                                ...
                                <ul class="list-inline two-part d-flex align-items-center mb-0">
                                    ...
                                    <li class="ms-auto"><span class="counter text-info"><?php  if(isset($countservice)){echo $countservice;}else{echo 0;}  ?></span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        require("plugins/actions/config.php");
                            if (
                                in_array($position, ["AC2-SM"])
                            )  { ?>
                            
                       
                        <div class="col-lg-4 col-md-12">
                            <div class="white-box analytics-info">
                                <h3 class="box-title">Total Ingredients</h3>
                                <ul class="list-inline two-part d-flex align-items-center mb-0">
                                    <li>
                                    ...
                                    <li class="ms-auto"><span class="counter text-info"><?php  if(isset($countingredient)){echo $countingredient;}else{echo 0;}  ?></span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-12">
                            <div class="white-box analytics-info">
                                <ts class="box-title">Total departments</h3>
                                <ul class="list-inline two-part d-flex align-items-center mb-0">
                                    <li>
                                    ...
                                    <li class="ms-auto"><span class="counter text-info"><?php  if(isset($countdepartment)){echo $countdepartment;}else{echo 0;}  ?></span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-12">
                            <div class="white-box analytics-info">
                                ...
                                <ul class="list-inline two-part d-flex align-items-center mb-0">
                                    ...
                                    <li class="ms-auto"><span class="counter text-info"><?php  if(isset($counttransaction)){echo $counttransaction;}else{echo 0;}  ?></span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        require("plugins/actions/config.php");
                            if (
                                in_array($position, ["AC2-FM","AC3-AM","AC3-GM"])
                            )  { ?>
                        ...
                        <div class="col-lg-4 col-md-12">
                            <div class="white-box analytics-info">
                                <h3 class="box-title">Total requests</h3>
                                <ul class="list-inline two-part d-flex align-items-center mb-0">
                                    <li>
                                        <div id="sparklinedash4"><canvas width="67" height="30"
                                                style="display: inline-block; width: 67px; height: 30px; vertical-align: top;"></canvas>
                                    ...
                                    <li class="ms-auto"><span class="counter text-info"><?php  if(isset($countrequest)){echo $countrequest;}else{echo 0;}  ?></span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        require("plugins/actions/config.php");
                            if (
                                in_array($position, ["AC2-FM","AC2-AM","AC3-AM","AC3-GM"])
                            )  { ?>
                        ...
                        <div class="col-lg-4 col-md-12">
                            <div class="white-box analytics-info">
                                <ts class="box-title">Total reviews</h3>
                                <ul class="list-inline two-part d-flex align-items-center mb-0">
                                    <li>
                                        <div id="sparklinedash5"><canvas width="67" height="30"
                                                style="display: inline-block; width: 67px; height: 30px; vertical-align: top;"></canvas>
                                    ...
                                    <li class="ms-auto"><span class="counter text-info"><?php  if(isset($countreview)){echo $countreview;}else{echo 0;}  ?></span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4 col-md-12">
                            <div class="white-box analytics-info">
                                ...
                                <ul class="list-inline two-part d-flex align-items-center mb-0">
                                    ...
                                    <li class="ms-auto"><span class="counter text-info"><?php  if(isset($countsales)){echo $countsales;}else{echo 0;}  ?></span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        require("plugins/actions/config.php");
                            if (
                                in_array($position, ["AC2-AM"])
                            )  { ?>
                       
                        <div class="col-lg-4 col-md-12">
                            <div class="white-box analytics-info">
                                <ts class="box-title">Popular Services</h3>
                                <ul class="list-inline two-part d-flex align-items-center mb-0">
                                    <li>
                                        <div id="sparklinedash5"><canvas width="67" height="30"
                                                style="display: inline-block; width: 67px; height: 30px; vertical-align: top;"></canvas>
                                    ...
                                    <li class="ms-auto"><span class="counter text-info"><?php  if(isset($countpopularservice)){echo $countpopularservice;}else{echo 0;}  ?></span>
                                    </li>
                                </ul>
                            </div>
                        </div>
 ...
 <!-- add something only store clerks see when they click logout modal so onclicking 
                                 ...
                                 so first they say connect to internet to continue also-->
...
<!--                             </div>
             ...
             <!-- ============================================================== -->
                ...
                <!-- footer -->
                <!-- ============================================================== -->
                <footer class="footer fix-bottom text-center"> 2024 © Jopal brought to you by JopalBusinessCenter
