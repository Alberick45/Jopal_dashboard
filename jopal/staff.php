...
<head>
    ...
    <title>Jopal - staff | <?php echo $user_name ?> </title>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                $sql = "SELECT staff_id,staff_name,phone_number,age, department.department_name FROM staff left join department on position_id = department_id";
                    ...
                    while ($row = $result->fetch_assoc()) {
                       ...
                       $record .= "<tr>
                                ...
                                if (in_array($accesslevel, [3])) {
                                    $record .= "<a class='btn btn-danger' href='plugins/actions/staff-operations.php?action=deletestaff&sid=" . urlencode($staffid) . "' role='button'>Delete</a>";
                                }
