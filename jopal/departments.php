...
<head>
    ...
    <title>Jopal departments  | <?php echo $user_name ?> </title>
...
<body>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        require("plugins/actions/config.php");
                            if (
                                ...
                                <td>
                                <a class='btn btn-danger' href='plugins/actions/department-operations.php?action=delete_department&did=<?php echo urlencode($departmentid); ?>' role='button'>Delete</a> 
                               </td>
                            </tr>
                            <?php 
                                }
                ...
                <?php
                    ...
                    $record = "<tr><td colspan='4'>No departments available</td></tr>";
                }
            ...
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add-departments-modal"  >
              Add departments
            </button>
                         <?php 
                            }
        ...
        <!-- ============================================================== -->
            ...
            <!-- this is the Add departments modal -->
            <div class="modal fade" id="add-departments-modal" tabindex="-1" aria-labelledby="departments-modal-title" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="departments-modal-title">Add departments</h5>
                  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                  <form action="plugins/actions/department-operations.php" method = 'POST' id="department" class="needs-validation" novalidate>
                    <input type="hidden" name="departmentlist" value="Add">
                    <div class="row g-3">
                        
                    <div class="col-6">
                        <input type="text" class="form-control" placeholder="departments id" aria-label="departments id" name="departmentid">
                      </div>
                      <div class="col-6">
                        <input type="text" class="form-control" placeholder="departments name" aria-label="departments name" name="departmentname" required>
                      </div>
                    ...
                    <button type="submit" class="btn btn-outline-danger" name="Add_department"  id="Dish">Add</button>
                  </form>
                </div>
