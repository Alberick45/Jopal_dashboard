...
<head>
    ...
    <title>Jopal inventory  | <?php echo $user_name ?> </title>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full"
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Stock Items</h4>
                    </div>
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <div class="d-md-flex">
                            <ol class="breadcrumb ms-auto">
                                ...
                                <a type="button" class="btn btn-danger  d-none d-md-block pull-right ms-3 hidden-xs hidden-sm waves-effect waves-light text-white" data-bs-toggle="modal" data-bs-target="#upload-customers-modal" >Upload Items</a>
                        </div>
                    </div>
                </div>
                <!-- /.col-lg-12 -->
            ...
            <div class="container-fluid">
                ...
                $sql = "SELECT inventory_id, item_name, total_quantity,price_per_unit FROM inventory ";
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        $Itemsname = htmlspecialchars($row["item_name"]);
                        $totalquantity = htmlspecialchars($row["total_quantity"]);
                        $price = htmlspecialchars($row["price_per_unit"]);
                        ?>
                ...
                <?php
                    ...
                    $record = "<tr><td colspan='4'>No Items in stock</td></tr>";
                }
                ...
                <?php 
                                        require("plugins/actions/config.php");
                                            if (in_array($accesslevel, [3]) || 
                                                in_array($position, ["AC1-SM"])
                                            )  { ?>
                           
                                         <!-- Add customers button that toggles to the add customers modal -->
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add-stock-items-modal"  >
              Add Items to Stock
            </button>
                         <?php 
                            }
        ...
        <!-- ============================================================== -->
            ...
            <!-- this is the Add Stock items modal -->
            <div class="modal fade" id="add-stock-items-modal" tabindex="-1" aria-labelledby="items-modal-title" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="items-modal-title">Add Stock items</h5>
                  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                  <form action="plugins/actions/inventory-operations.php" method = 'POST' id="inventory" class="needs-validation" novalidate>
                    <input type="hidden" name="inventorylist" value="Add">
                    <div class="row g-3">
                      <div class="col-6">
                        <input type="text" class="form-control" placeholder="Stock items name" aria-label="Items name" name="Itemsname" required>
                      </div>
                      <div class="col-6">
                        <input type="number" class="form-control" placeholder="Items Price" aria-label="Items Price" name="Itemsprice" value="0.00" required>
                      </div>
            
              
                      <div class="col-6">
                        <input type="number" class="form-control" placeholder="Items quantity" aria-label="Items quantity" min="1" name="Itemsquantity">
                      </div>
                    

                    </div> 
                    <button type="submit" class="btn btn-outline-danger" name="Add_Items"  id="Items">Add</button>
                  </form>
                </div>
