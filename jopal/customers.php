...
<head>
    ...
    <title>Jopal - Customers  | <?php echo $user_name ?> </title>
                ...
                <ul id="sidebarnav">
                        ...
                        require("plugins/actions/config.php");
                            if (
                                ...
                                in_array($position, ["AC2-AA","AC1-C"])
                            )  { ?>
                ...
                if ($result->num_rows > 0) {
                    ...
                    ?>
                       <tr>
                                ...
                                <td>
                                <a class='btn btn-danger' href='plugins/actions/customer-operations.php?action=delete_customer&cid=<?php echo urlencode($customerid); ?>' role='button'>Delete</a> |
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form action="plugins/actions/customer-operations.php" method = 'POST' id="customer" class="needs-validation" novalidate>
  ...
  <!-- =============================================== -->
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="plugins/actions/customer_upload.php"  id="signin" method="POST" class="needs-validation" novalidate enctype="multipart/form-data">
